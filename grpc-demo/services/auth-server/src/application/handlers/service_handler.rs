...
// use crate::infrastructure::web::dto::service::request::CreateServiceDTO;
// use crate::infrastructure::web::dto::service::response::ServiceVO;
// use axum::{
//     Json,
...
//     responses(
//         (status = 201, description = "创建成功", body = ServiceVO),
...
// ) -> AppResult<ApiResponse<ServiceVO>> {
//     // 验证请求参数
//     payload
//         .validate()
